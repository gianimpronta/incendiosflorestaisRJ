...
A coluna incendio será a nossa coluna alvo. Desde já, podemos percerber que as classes da nossa coluna alvo está desbalanceada o que poderá interferir na mineração de dados. 

Desse medo, iremos criar um novo dataset com as classes balanceadas.
```{r Balanceamento de classes}
